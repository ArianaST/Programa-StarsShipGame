...
public class GameState extends State{
	...
	public static final Vector2D PLAYER_START_POSITION = new Vector2D((Constants.WIDTH/2 - Assets.player.getWidth()/2)-100,
			Constants.HEIGHT/2 - Assets.player.getHeight()/2);

	public static final Vector2D PLAYER2_START_POSITION = new Vector2D((Constants.WIDTH/2 - Assets.player.getWidth()/2)+100,
			Constants.HEIGHT/2 - Assets.player.getHeight()/2);
	...
	public GameState()
	{
		...
		player2 = new Player2(PLAYER2_START_POSITION, new Vector2D(),
	...
	public void update(float dt)
	{
		...
		if(gameOverTimer > Constants.GAME_OVER_TIME) {
			...
			try {
				...
				dataList.add(new ScoreData(DatosJugador.getNombre(), score, Contador.muertes));
				JSONParser.writeFile(dataList);*/
				ScoreData scoreData = new ScoreData(DatosJugador.getNombre(),score,Contador.getMuertes());
				Crud.insertEquipo(1,scoreData.getNombre(),scoreData.getMuertes());
				Crud.insertResultados(1,scoreData.getDate(),scoreData.getScore());
