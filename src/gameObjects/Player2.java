...
public class Player2 extends MovingObject{
	...
	public Player2(Vector2D position, Vector2D velocity, double maxVel, BufferedImage texture, GameState gameState) {
	...
	public void update(float dt) 
	{
		...
		if(KeyBoard.SHOOT2 &&  fireRate > fireSpeed && !spawning)
		{
